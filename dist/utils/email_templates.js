...
exports.createPasswordResetTemplate = exports.createEmailVerificationTemplate = void 0;
function createEmailVerificationTemplate(link) {
    const template = `
    <!DOCTYPE html>
    <html lang="en">
    <head>
...
exports.createEmailVerificationTemplate = createEmailVerificationTemplate;
function createPasswordResetTemplate(link) {
    const template = `
    <!DOCTYPE html>
<html lang="en">
<head>
